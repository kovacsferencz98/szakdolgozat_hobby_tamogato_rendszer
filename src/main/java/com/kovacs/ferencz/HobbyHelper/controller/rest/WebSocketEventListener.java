...
public class WebSocketEventListener {
    ...
    public void handleWebSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (username != null) {
            ...
            chatMessageVM.setType(ChatMessageVM.MessageType.LEAVE);
            chatMessageVM.setSender(username);

            messagingTemplate.convertAndSend(format("/channel/%s", roomId), chatMessageVM);
        }
    }
}
